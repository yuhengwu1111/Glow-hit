window.translations['es'] = {
    // Navbar & Footer
    navHome: "Inicio", navProduct: "Producto", navSimulator: "Simulador", navVision: "Visión", navScience: "Ciencia", navAbout: "Pitch", navTry: "Probar ahora",
    ...
    visionOriginDesc: "En las ciudades modernas, identificamos dos dilemas familiares urgentes profundamente enraizados en cada hogar:\n\n[Inconveniente para los mayores]: Muchas personas de la tercera edad tienen problemas de movilidad, cambios climáticos o riesgos de tránsito que les impiden entrenar fuera, acelerando el deterioro de sus reflejos y capacidades cognitivas.\n\n[Falta de actividad física en niños]: Los niños pasan demasiado tiempo frente a pantallas de teléfonos o tabletas, lo que genera falta de coordinación visomotora y dispersión de la atención.\n\nGlowHit se creó para solucionar esto: sin salir de casa, los abuelos pueden ejercitar reflejos de forma segura y divertida en la sala, activando su visión periférica; al mismo tiempo, los niños lo usan como un videojuego físico real para quemar energía sin pantallas, uniendo a toda la familia en una vida sana.",
    visionAudienceTitle: "2. Público objetivo y Beneficios bilaterales",
    visionTA1Title: "Adultos mayores (Prevención de caídas y Rehabilitación)",
    visionTA1Desc: "Reduce el retraso neuromotor mediante el entrenamiento del tiempo de reacción de paso selectivo (CSRT), activando el campo visual periférico y disminuyendo el riesgo de caídas y fracturas.",
    visionTA2Title: "Niños en edad escolar (Juego activo sin pantallas)",
    visionTA2Desc: "Protege sus ojos de pantallas virtuales dañinas. Funciona como un juguete de alto impacto físico para competencias en la sala, estimulando la concentración y la motricidad dorada en el proceso.",
    visionTA3Title: "Hogar inteligente (Estética espacial activa las 24 horas)",
    visionTA3Desc: "Se integra con Apple Home y Siri. En reposo es una elegante luz ambiental decorativa, resolviendo el problema de los pesados equipos tradicionales que terminan olvidados juntando polvo.",
