window.translations['ja'] = {
    ...
    legoDesc: "レゴと100%互換의 ベースプレート構造。予算や空間に応じて、ハニカム状、マトリクス状、あるいは非対称など自由自在に配置可能。",
    ...
    modeFloor: "シャドウチェイサー",
    modeFloorDesc: "ワイヤレス独立モジュールで配置制限なし。子どもたちが物理空間で走り回り、色を識別して叩くことで、身体能力と空間認知力を全面的に刺激します！",
    ...
    visionTA2Desc: "目に優しい実体的な遊び道具として、リビングで打撃競争を楽しむことができます。楽しいゲームの中でエネルギーを発سنしながら、手眼協調性と脳の集中力の発達を促します。",
    ...
    svgSwitches: "マイクロスイッチ",
    svgMCU: "ESP32 基板",
    svgBattery: "3000mAh 安全バッテリー",
    svgLego: "モジュール式底板",
    partPlate: "円形押壓板",
    partPlateDesc: "押圧板。打撃時に荷重を均一に下方向へ伝え、マイクロスイッチをトリガーします。",
    partDiffuser: "乳白色導光カバー",
    partDiffuserDesc: "WS2812Bの発光を美しく拡散させ、目に優しく温かみのある鮮やかなグラデーション光を演出。",
    partSwitches: "微動センサー",
    partSwitchesDesc: "高感度マイクロスイッチにより、死角のない打撃感知を実現。",
    partMCU: "ESP32 制御コア基板",
    partMCUDesc: "超高速Wi-Fi/BLEを搭載したメインコア。OTAワレスアップデートによる機能拡張をサポート。",
    partBattery: "3000mAh リチウム電池パック",
    partBatteryDesc: "充放電保護回路内蔵。5V Type-C急速充電対応で、コードレスのスマート配置を可能に。",
    partLego: "モジュール式底板",
    partLegoDesc: "頑丈なベース、モジュール式穴をあらかじめ配置し、クイック着脱と無限の連結レイアウトを実現。",
    ...
    sci3Desc: "PMC医学データバンク (PMC12921918) に登録された最新研究によると、目標ターゲットの視覚的な「認知」と、三方向の高速「衝撃擊打」を組み合わせた統合デュアルタスク訓練は、運動前神経遅延（Premotor time）を著しく改善し、手眼調和、動作敏捷性、および妨害ノイズに対する選択적 空間注意集中力を優位に向上させます。",
    ...
    slide1Desc: "忙しい現代生活では、健康トレーニングと家庭用デザインとの調과が取れていません。GlowHitはゲーミフィケーションを通じて日常に運動をもたらし、美しいインテリジェント照明にもなります。",
