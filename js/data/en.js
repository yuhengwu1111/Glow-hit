window.translations['en'] = {
    ...
    modeTimerDesc: "Challenge your hitting limits within the time limit.",
    modeFloor: "Light Chaser",
    modeFloorDesc: "Wireless independent modules with unrestricted placement. Let children run, jump, spot colors, and press in physical space, fully stimulating fitness potential and spatial perception!",
    ...
    svgPlate: "Circular Trigger Plate",
    svgDiffuser: "Translucent Light Guide",
    svgSwitches: "Micro switch",
    svgMCU: "ESP32 Mainboard",
    svgBattery: "3000mAh Safety Battery",
    svgLego: "Modular Base",
    partPlate: "Circular Press Plate",
    partPlateDesc: "Press plate, evenly triggers micro-switches downward when hit.",
    ...
    partSwitchesDesc: "High-sensitivity micro-switches, achieving deadzone-free hits.",
    ...
    partBattery: "3000mAh Lithium Battery Pack",
    partBatteryDesc: "Built-in protection circuit supporting 5V Type-C quick charging for all-day portability.",
    partLego: "Modular Chassis",
    partLegoDesc: "Stable base with modular holes for quick release and infinite configurations.",
