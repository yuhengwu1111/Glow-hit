    ...
    app.innerHTML = `
        <section class="max-w-4xl mx-auto px-4 md:px-6 pt-8 md:pt-12">
            <div class="text-center mb-10 md:mb-16">
                ...
                <p class="text-gray-500 mt-3 md:text-base max-w-2xl mx-auto">${t.visionSubtitle}</p>
            </div>
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="bg-white border border-gray-100 p-6 rounded-2xl shadow-sm text-left hover:shadow-md transition-all">
